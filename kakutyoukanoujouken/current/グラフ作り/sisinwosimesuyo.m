...
params = struct( ...
    ...
    'w1_mass',  22.5e-3, ...    % [m] ★質量・面積計算用（平均値 22.5mm）
    't1',  0.1e-3, ...    % [m]
    'E1',  34.5e9, ...      % [Pa]
    'rho1',1250, ...       % [kg/m^3]
    'S2',  152.522e-6, ...  % [m^2]
...
for i = 1:length(freq_range)
    f_curr = freq_range(i);
    waitbar(i/length(freq_range), h_wait, sprintf('解析中: %.2f Hz', f_curr));
